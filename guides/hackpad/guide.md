| title | Hackpad |
| --- | --- |
| description | Build a custom macropad — PCB, case, and firmware |
| priority | 95 |
...
**Read over the [FAQ](https://hackpad.hackclub.com/faq) first so that you have an idea of what you're working with!**
...
There's also [this](https://hackpad.hackclub.com/resources) giant wall of resources to reference!
...
<img src="https://hackpad.hackclub.com/docs/v2/schematicbutton.png" className="max-w-96" />
...
<img src="https://hackpad.hackclub.com/docs/v2/placedcomponents.png" className="max-w-96" />
...
<img src="https://hackpad.hackclub.com/docs/v2/wiredcomponents.png" className="max-w-96" />
...
<img src="https://hackpad.hackclub.com/docs/v2/assignfootprints.png" className="max-w-96" />
...
<img src="https://hackpad.hackclub.com/docs/v2/assignedfootprints.png" className="max-w-200" />
...
<img src="https://hackpad.hackclub.com/docs/v2/switchtopcb.png" className="max-w-96" />

Hit the "Update PCB from schematic" button in the top right. This will bring in all your parts!

<img src="https://hackpad.hackclub.com/docs/v2/updatefromschematic.png" className="max-w-96" />

Click anywhere on your screen to place your components down, it should look something like this:

<img src="https://hackpad.hackclub.com/docs/v2/pcbstart.png" className="max-w-96" />
...
<img src="https://hackpad.hackclub.com/docs/v2/grid.png" className="max-w-96" />

You should have the following menu open:

<img src="https://hackpad.hackclub.com/docs/v2/editgrid.png" className="max-w-96" />
...
<img src="https://hackpad.hackclub.com/docs/v2/align.png" className="max-w-96" />

There is a front side and back side of the board. You can tell them apart by color

<img src="https://hackpad.hackclub.com/docs/v2/frontback.png" className="max-w-96" />

If you want to put the footprint on the back side, press F. Here is what the footprints look like on different sides:

<img src="https://hackpad.hackclub.com/docs/v2/compfrontback.png" className="max-w-96" />

Move, rotate and flip your footprints into a design that you like! It should look something like this:

<img src="https://hackpad.hackclub.com/docs/v2/placedfootprints.png" className="max-w-96" />

You need to define the outline of the board. Select the Edge.Cuts layer on the right toolbar.

<img src="https://hackpad.hackclub.com/docs/v2/righttoolbar.png" className="max-w-96" />

Now, you can use the "Draw Rectangle" button to draw the boarders of the board:

<img src="https://hackpad.hackclub.com/docs/v2/edgecutsselect.png" className="max-w-96" />
...
<img src="https://hackpad.hackclub.com/docs/v2/xiaohead.png" className="max-w-96" />
...
<img src="https://hackpad.hackclub.com/docs/v2/routing.png" className="max-w-96" />
...
<img src="https://hackpad.hackclub.com/docs/v2/via.png" className="max-w-96" />
...
<img src="https://hackpad.hackclub.com/docs/v2/finalpcb.png" className="max-w-96" />
...
<img src="https://hackpad.hackclub.com/docs/v2/addtext.png" className="max-w-96" />

Enter your text and place it down! 

<img src="https://hackpad.hackclub.com/docs/v2/realfinalpcb.png" className="max-w-96" />

If you want to add some pictures to your PCB to make it even more personal, [check this out!](https://hackpad.hackclub.com/advancedguide#silkscreen)

Good work! You're almost done with the PCB. Let's run the DRC to make sure the PCB works. The silkscreen warnings you see are okay, make sure there are no more errors! Here is a [list of all DRC errors you might encounter](https://hackpad.hackclub.com/errors)

<img src="https://hackpad.hackclub.com/docs/v2/drcbutton.png" className="max-w-96" />

PS. You might need to change tabs to see all errors. (Click on "Unconnected Items")

Thats all for your PCB! Great job.

If you aren't satisfied and wan't something more advanced, [check out the advanced PCB guide!](https://hackpad.hackclub.com/advancedPCB)
...
<img src="https://hackpad.hackclub.com/docs/v2/layout.png" className="max-w-96" />
...
<img src="https://hackpad.hackclub.com/docs/v2/fusioncomp.png" className="max-w-96" />
<img src="https://hackpad.hackclub.com/docs/v2/newcomponent.png" className="max-w-96" />
...
<img src="https://hackpad.hackclub.com/docs/v2/ruler.png" className="max-w-96" />
<img src="https://hackpad.hackclub.com/docs/v2/pcbsize.png" className="max-w-96" />
...
<img src="https://hackpad.hackclub.com/docs/v2/1sketch1.png" className="max-w-96" />
...
<img src="https://hackpad.hackclub.com/docs/v2/fusionrect.png" className="max-w-96" />
<img src="https://hackpad.hackclub.com/docs/v2/fusiondim.png" className="max-w-96" />
<img src="https://hackpad.hackclub.com/docs/v2/1sketch2.png" className="max-w-96" />

Create another rectangle with 20mm extra on each dimension! (I will have 61mm x 82.7mm):

<img src="https://hackpad.hackclub.com/docs/v2/fusionrect2.png" className="max-w-96" />
...
<img src="https://hackpad.hackclub.com/docs/v2/fusionrect3.png" className="max-w-96" />
...
<img src="https://hackpad.hackclub.com/docs/v2/fusioncircle.png" className="max-w-96" />
<img src="https://hackpad.hackclub.com/docs/v2/fusioncircledim.png" className="max-w-96" />
<img src="https://hackpad.hackclub.com/docs/v2/fusioncircle2.png" className="max-w-96" />
...
<img src="https://hackpad.hackclub.com/docs/v2/fusioncoincident.png" className="max-w-96" />
<img src="https://hackpad.hackclub.com/docs/v2/fusionfinishsketch.png" className="max-w-96" />
...
<img src="https://hackpad.hackclub.com/docs/v2/fusionextrude.png" className="max-w-96" />
<img src="https://hackpad.hackclub.com/docs/v2/fusionselect.png" className="max-w-96" />
<img src="https://hackpad.hackclub.com/docs/v2/fusionextrudemenu.png" className="max-w-96" />
...
<img src="https://hackpad.hackclub.com/docs/v2/fusionshow.png" className="max-w-96" />
<img src="https://hackpad.hackclub.com/docs/v2/fusionextrude2.png" className="max-w-96" />

Now, click the center square, and extrude it by 3mm. You can move arround and you will see something like this:

<img src="https://hackpad.hackclub.com/docs/v2/fusioncasehalf.png" className="max-w-96" />
...
<img src="https://hackpad.hackclub.com/docs/v2/kicadusbdist.png" className="max-w-96" />

Now select the top of the case:

<img src="https://hackpad.hackclub.com/docs/v2/fusiontop.png" className="max-w-96" />
...
<img src="https://hackpad.hackclub.com/docs/v2/fusionhole.png" className="max-w-96" />

Click finish sketch, select the rectangle we just drew and press extrude. This time set the distance to -7.5mm

<img src="https://hackpad.hackclub.com/docs/v2/fusioncase.png" className="max-w-96" />
...
<img src="https://hackpad.hackclub.com/docs/v2/fillet.png" className="max-w-96" />
<img src="https://hackpad.hackclub.com/docs/v2/edgeround.png" className="max-w-96" />
<img src="https://hackpad.hackclub.com/docs/v2/fusiongfinaltop.png" className="max-w-96" />

## Creating the top

Next, we will make the other half of our case. Start by clicking new design.

<img src="https://hackpad.hackclub.com/docs/v2/fusionnewdesign.png" className="max-w-96" />
...
<img src="https://hackpad.hackclub.com/docs/v2/fusionholes.png" className="max-w-96" />

Now select everything and click on the Lock button

<img src="https://hackpad.hackclub.com/docs/v2/fusionlock.png" className="max-w-96" />
...
<img src="https://hackpad.hackclub.com/docs/v2/ruler.png" className="max-w-96" />
<img src="https://hackpad.hackclub.com/docs/v2/swoffset.png" className="max-w-96" />
...
<img src="https://hackpad.hackclub.com/docs/v2/fusionalmost.png" className="max-w-96" />
...
<img src="https://hackpad.hackclub.com/docs/v2/fusionfinalsketch.png" className="max-w-96" />

Click finish sketch, and pad out the main part by 1.5mm.

<img src="https://hackpad.hackclub.com/docs/v2/fusionplate.png" className="max-w-96" />

But currently the plate is kinda ugly. Do the same things with the fillet as the case:

<img src="https://hackpad.hackclub.com/docs/v2/fusionplatefinal.png" className="max-w-96" />
...
<img src="https://hackpad.hackclub.com/docs/v2/createtext.png" className="max-w-96" />
...
<img src="https://hackpad.hackclub.com/docs/v2/extrudedtext.png" className="max-w-96" />

Thats it! Your case is now done.

I would also recommend importing 3d models of all your components to test fit everything: 

<img src="https://hackpad.hackclub.com/docs/v2/testedcase.png" className="max-w-96" />
...
Or maybe do you think you are done? Check out how to submit [here](https://hackpad.hackclub.com/submitting)
