class Api::V1::ProjectsController < Api::V1::BaseController
  ...
  def index
    ...
    render json: {
      data: @projects.as_json(only: [ :id, :name, :description, :tags, :repo_link, :created_at, :updated_at ]),
  ...
  def show
    ...
    render json: {
      data: @project.as_json(only: [ :id, :name, :description, :tags, :repo_link, :created_at, :updated_at ])
    }
  end
end
