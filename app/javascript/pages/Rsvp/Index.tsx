    ...
    <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
      <style
        dangerouslySetInnerHTML={{
          __html: `@keyframes float { 0% { transform: translateY(110vh); } 100% { transform: translateY(-100px); } }`,
        }}
      />
      {icons.map((item, i) =>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-stone-400 text-base leading-relaxed mb-5">
                Join thousands of teenagers who are learning as well. Check out our written and video tutorials. Ask
                questions in the <span className="text-[#ffb595] font-mono">#forge</span> channel on Slack.
              </p>
              <a
