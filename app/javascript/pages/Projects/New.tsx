...
const TIERS: TierOption[] = [
  {
    ...
    label: 'Tier 1',
    rate: '7.25c / hour',
    description: 'Smallest projects. Highest steel coin rate per hour.',
    pitch: false,
  },
  {
    tier: 'tier_2',
    label: 'Tier 2',
    rate: '5.5c / hour',
    description: 'Standard projects. Solid coin rate.',
    pitch: false,
  },
  {
    tier: 'tier_3',
    label: 'Tier 3',
    rate: '4.5c / hour',
    description: 'Bigger builds. More budget, fewer coins per hour.',
    pitch: false,
  },
  {
    tier: 'tier_4',
    label: 'Tier 4',
    rate: '4c / hour',
    description: 'Advanced project ($200+). Requires a Slack pitch.',
    pitch: true,
  },
]
