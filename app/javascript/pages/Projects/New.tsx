...
const TIERS: TierOption[] = [
  {
    ...
    label: 'Tier 1',
    rate: '7.25c / hour',
    description: 'Advanced project ($200+). Highest coin rate. Requires a Slack pitch.',
    pitch: true,
  },
  {
    tier: 'tier_2',
    label: 'Tier 2',
    rate: '5.5c / hour',
    description: 'Bigger builds. Solid coin rate.',
    pitch: false,
  },
  {
    tier: 'tier_3',
  ...
  },
  {
    ...
    label: 'Tier 4',
    rate: '4c / hour',
    description: 'Basic project. The simplest starting point.',
    pitch: false,
  },
]
