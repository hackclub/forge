    ...
    <div className="p-5 md:p-12 max-w-2xl mx-auto">
      ...
      <div className="bg-[#1c1b1b] ghost-border p-8 mb-8">
        ...
        <div className="text-stone-500 text-sm leading-relaxed font-mono space-y-2">
          <p>
            <span className="text-stone-300">Name:</span> Your project name
          </p>
          <p>
            <span className="text-stone-300">I&apos;m designing:</span> what you&apos;re building
          </p>
          <p>
            <span className="text-stone-300">Inspo / reference:</span> links &amp; references
          </p>
          <p>
            <span className="text-stone-300">Past projects:</span> your experience
          </p>
          <p>
            <span className="text-stone-300">Why this is worth more than $200:</span> justification
          </p>
          <p>
            <span className="text-stone-300">Rough BOM:</span>
          </p>
          <p className="pl-4">Item $XX</p>
          <p className="pl-4">Item $XX</p>
          <p>
            <span className="text-stone-300">Total:</span> $XXX
          </p>
        </div>
      </div>
