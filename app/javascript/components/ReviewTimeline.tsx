  ...
  return (
    <section className="mb-12">
      <button
        ...
        className="w-full text-left text-xs font-bold uppercase tracking-[0.2em] text-stone-500 font-headline mb-4 flex items-center justify-between gap-2 cursor-pointer hover:text-stone-400 transition-colors"
      >
