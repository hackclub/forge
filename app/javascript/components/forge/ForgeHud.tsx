...
export default function ForgeHud({ coinBalance }: { coinBalance: number }) {
  ...
  return (
    <>
      ...
      {user.is_staff && (
        <div className="absolute bottom-16 right-4 z-30 md:bottom-4">
          <Link
            href="/admin"
            title="Admin dashboard"
            className="group flex items-center gap-1.5 bg-[#1c1b1b]/90 px-3 py-2 corner-accents ghost-border transition-colors hover:bg-[#2a2a2a]"
          >
            <span
